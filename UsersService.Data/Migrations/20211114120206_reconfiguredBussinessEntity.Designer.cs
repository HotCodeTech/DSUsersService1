...
namespace UsersService.Data.Migrations
{
    ...
    [Migration("20211114120206_reconfiguredBussinessEntity")]
    partial class reconfiguredBussinessEntity
    {
            ...
            modelBuilder.Entity("UsersService.Data.Entities.VehicleEntity", b =>
                {
                    ...
                    b.HasIndex("VIN", "RegistrationNumber")
                        .IsUnique()
                        .HasFilter("[VIN] IS NOT NULL AND [RegistrationNumber] IS NOT NULL");
